  ...
  return (
    <section className="py-16 bg-neutral-50" aria-labelledby="social-heading">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 id="social-heading" className="font-serif text-3xl sm:text-4xl font-bold text-neutral-900">
          Join the Jest
        </h2>
        <p className="mt-4 text-lg text-neutral-600">
          Follow our journey. See apartment drops, renovation stories, and local adventures.
        </p>
        <div className="mt-4 w-16 h-0.5 bg-primary-600 mx-auto mb-8"></div>
