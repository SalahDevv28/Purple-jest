        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <nav aria-label="Footer navigation">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/information" className="hover:text-primary-400 transition-colors text-sm">
                  Information
                </Link>
              </li>
              <li>
                <Link href="/shop" className="hover:text-primary-400 transition-colors text-sm">
                  Shop
                </Link>
              </li>
              <li>
